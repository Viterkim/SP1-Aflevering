...
public class RandomUserForm extends javax.swing.JFrame  implements Observer
{
  ...
  {
    initComponents();
    randomUserControl = new RandomUserControl();
    randomUserControl.addObserver(this);
    t = new Thread(randomUserControl);
  }
  ...
  // End of variables declaration//GEN-END:variables
    ...
    {
        RandomUser user1 = (RandomUser) arg;
        textFirstName.setText(user1.getFirstName());
        textLastName.setText(user1.getLastName());
        textStreet.setText(user1.getStreet());
        textCity.setText(user1.getCity());
        textEmail.setText(user1.getEmail());
    }
